(globalThis["webpackChunkmysteryfunhouse"] = globalThis["webpackChunkmysteryfunhouse"] || []).push([["src_extension_timer_js"],{
...
nodecg.log.info("To edit me, open \"".concat(__filename, "\" in your favorite text editor or IDE."));
