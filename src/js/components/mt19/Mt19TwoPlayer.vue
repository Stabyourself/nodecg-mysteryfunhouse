<template>
  <v-app>
    <div id="top-section">
      <mt19-player-box :player="player0" :visible="visible" side="left" />
      <mt19-player-box :player="player1" :visible="visible" side="right" />
    </div>
    ...
    <div id="bottom-section">
      <mt19-game-box :game="game" :goal="goal" :submitter="submitter" :visible="visible" :boxart="currentBoxart" />
