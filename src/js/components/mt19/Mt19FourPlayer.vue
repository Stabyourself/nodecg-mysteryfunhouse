<template>
  <v-app>
    <div id="section-wrapper">
      ...
      <div id="main-section">
        <div class="main-row">
          <mt19-player-box :player="player0" :visible="visible" side="left" class="compact" />
          <div class="round">{{ round1 }}</div>
          <mt19-player-box :player="player1" :visible="visible" side="right" class="compact" />
        </div>
        ...
        <div class="main-row">
          <mt19-player-box :player="player2" :visible="visible" side="left" class="compact" />
          <div class="round">{{ round2 }}</div>
          <mt19-player-box :player="player3" :visible="visible" side="right" class="compact" />
        </div>
      </div>
    </div>
