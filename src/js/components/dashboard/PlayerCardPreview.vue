    ...
    <v-app>
        <v-main>
            ...
            <v-tabs-items v-model="tab">
                <v-tab-item style="width: 500px" class="mx-auto my-4 text-center"><p>This tab is just here because Firefox has a bug that makes it error if I try to render to a canvas in an invisible iframe, like this one!</p>
